...
func newMetricsClientTestCase() *metricsClientTestCase {
	...
	testCase := &metricsClientTestCase{
		...
		namespace:         &core.Namespace{ObjectMeta: metav1.ObjectMeta{Name: namespaceName}},
	}
...
func (tc *metricsClientTestCase) createFakeMetricsClient() MetricsClient {
	...
	fakeMetricsGetter.AddReactor("list", "pods", func(action testing.Action) (handled bool, ret runtime.Object, err error) {
...
func calculateResourceList(usage model.Resources) core.ResourceList {
	...
	resourceMap := map[core.ResourceName]resource.Quantity{
		core.ResourceCPU:    resource.MustParse(cpuQuantityString),
		core.ResourceMemory: resource.MustParse(memoryQuantityString),
	}
	return core.ResourceList(resourceMap)
}
